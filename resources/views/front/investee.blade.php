...
<div class="page-title light" style="background:url(assets/img/banner-4.jpg);">
	...
	<div class="container">
		...
		<div class="page-caption">
			...
			<h2>Browse Investee</h2>

			<p><a href="#" title="Home">Home</a> <i class="ti-arrow-right"></i> Browse Investee</p>
			...
			<div class="col-md-3 col-sm-12 jv-side">
				...
				<div class="widget-boxed padd-bot-0 lg zx100">
					...
					<div class="widget-boxed-body map-searches">
						<div class="">
					<form action="{{route('filterInvestee')}}" method="post" accept-charset="utf-8">
						@csrf
					...
					<div class="widget-boxed-body">
						<div class="side-list no-border">
							...
							<ul>
								...
								<input type="hidden" name="lookingfor" value="lookingForInvestment">
				...
				<div class="d-flex flex-wrap justify-content-between align-items-center sidebarSubmit">
					...
					<a class="btn btn-secondary btn-m" href="{{URL::to('/investees')}}">Clear</a>
				</div>
